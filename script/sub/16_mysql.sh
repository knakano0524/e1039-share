...
mkdir -p $DIR_WORK
cd       $DIR_WORK
wget --quiet -O mariadb-5.5.60.tar.gz "https://downloads.mariadb.org/interstitial/mariadb-5.5.60/source/mariadb-5.5.60.tar.gz/from/https%3A//archive.mariadb.org/"
