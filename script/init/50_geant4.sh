...
cmake  -DCMAKE_INSTALL_PREFIX=$DIR_INST  -DCLHEP_ROOT_DIR=$DIR_INST  -DGEANT4_BUILD_CXXSTD=c++11  -DGEANT4_INSTALL_DATA=ON  -DGEANT4_USE_GDML=ON  -DGEANT4_USE_OPENGL_X11=ON  ../geant4.10.01.p03
make -j6
make install
